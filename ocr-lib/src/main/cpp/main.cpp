...
Java_realcool_ocrlib_OcrEngine_init(JNIEnv *env, jobject thiz, jobject assetManager,
                                               jint numThread) {
...
Java_realcool_ocrlib_OcrEngine_detect(JNIEnv *env, jobject thiz, jobject input, jobject output,
...
Java_realcool_ocrlib_OcrEngine_benchmark(JNIEnv *env, jobject thiz, jobject input,
                                                    jint loop) {
    int padding = 50;
    int maxSideLen = 0;
